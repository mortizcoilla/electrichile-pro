  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        ric: 4,
        article: '5.30',
        title: 'Colores de canalizaciones',
        summary: 'Las canalizaciones eléctricas deben identificarse adecuadamente. No se podrán usar los colores rojo, amarillo o azul en las canalizaciones (se refiere al conduit/tubería, no a la aislación de los conductores).',
        calculatorIds: [],
      },
      {
        id: 'ric-04-5-32',
        ric: 4,
        article: '5.32',
        title: 'Código de colores de los conductores',
        summary: 'L1=azul, L2=negro, L3=rojo, Neutro y tierra de servicio=blanco, Conductor de protección=verde o verde/amarillo.',
        quote: 'Los conductores de una canalización eléctrica se identificarán según el siguiente código de colores: Conductor de la fase 1 — azul. Conductor de la fase 2 — negro. Conductor de la fase 3 — rojo. Conductor de neutro y tierra de servicio — blanco. Conductor de protección — verde o verde/amarillo.',
        calculatorIds: ['colors'],
      },
      {
        id: 'ric-04-5-33',
        ric: 4,
        article: '5.33',
        title: 'Restricciones del verde/amarillo',
        summary: 'Las cubiertas o aislaciones verde o verde/amarillo solo se emplearán para conductores de protección (puesta a tierra). No se permite usar multiconductores con cubierta exterior verde/amarillo para otros fines.',
        calculatorIds: ['colors'],
      },
    ],
  },
